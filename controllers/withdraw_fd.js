const fdSchema = require("../models/fixedDepositeSchema");
...
//   console.log("P1");
  ...
  const updateUser = await userSchema.updateOne({AccountNo: account}, {
    $set: {
      Bank_Balance: Number(req.authuser.Bank_Balance + amount)
    }
  });
